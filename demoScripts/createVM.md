...
The following example uses hard coded values for each of the parameters as one of the acceptable (but not recommended) patterns for an Executable document.
