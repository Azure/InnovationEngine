<!-- Original docs from https://azure-samples.github.io/aks-labs/docs/getting-started/getting-started-with-k8s-on-aks/ 
https://github.com/Azure-Samples/aks-labs/blob/main/docs/getting-started/getting-started-with-k8s-on-aks.md -->
...
9. `terraform apply` will deploy the required resources (add `-auto-approve` to avoid the manual approval step, be cautious of using this).  In 10-15 minutes, your lab environment should be ready to go.
