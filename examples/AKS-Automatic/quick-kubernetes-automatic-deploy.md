Note that this document is an Executable Docs version of https://learn.microsoft.com/en-us/azure/aks/learn/quick-kubernetes-automatic-deploy?pivots=azure-cli taken as a snapshot on 1/17/25. For the latest version please visit the published document.
...
<!-- TODO: Innovation Engine errors when this is uncommented
This quickstart assumes a basic understanding of Kubernetes concepts. For more information, see [Kubernetes core concepts for Azure Kubernetes Service (AKS)][kubernetes-concepts].
-->
<!-- TODO: enable Includes 
[!INCLUDE [azure-cli-prepare-your-environment-no-header.md](~/reusable-content/azure-cli/azure-cli-prepare-your-environment-no-header.md)]
-->

- An up-to-date install of [AZ CLI](../Common/Prerequisite-AzureCLIAndSub.md) logged in to an active subscription.
- [Install the aks-preview Azure CLI extension](../Common/Prerequisite-aks-preview-cli-extension.md) version **9.0.0b4** or later.
