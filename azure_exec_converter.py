...
def create_pr(filename):    
    ...
    subprocess.run(f"gh pr create --title 'AI generated doc titled {filename}' --body 'This PR was generated by AI for an existing Azure Doc: {filename}. Please review and merge.'", shell=True)
