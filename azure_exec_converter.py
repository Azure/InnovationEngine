...
# relevant_azure_docs = ['https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/aks/azure-csi-disk-storage-provision.md', 'https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/virtual-machines/linux/quick-create-cli.md']
### END OF USER INPUT ###
...
<<<<<<< Updated upstream
    # subprocess.run(['gh', 'pr', 'create', '--title', f"AI generated doc titled {filename}", '--body',  f"This PR was generated by AI for an existing Azure Doc: {filename}. Please review and merge.", '--label', label])
    process = subprocess.Popen(['gh', 'pr', 'create', '--title', f"AI generated doc titled {filename}", '--body',  f"This PR was generated by AI for an existing Azure Doc: {filename}. Please review and merge.", '--label', label, '--head', f'aiexecdocs/{branch_name}'], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
=======
    ...
    process = subprocess.Popen(['gh', 'pr', 'create', '--title', f"AI generated doc titled {dirname}", '--body',  f"This PR was generated by AI for an existing Azure Doc: {dirname}. Please review and merge.", '--label', label, '--head', branch_name], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
>>>>>>> Stashed changes
...
#         if match:
#             azure_doc_name = match.group(1).replace(' ', '_').replace("'", "").replace('"', '').replace(':', '').lower()
