...
def create_pr(filename):    
    ...
    subprocess.run(['gh', 'pr', 'create', '--title', f"AI generated doc titled {filename}", '--body',  f"This PR was generated by AI for an existing Azure Doc: {filename}. Please review and merge."])
