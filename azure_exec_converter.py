...
def create_pr(filename):  
    ...
    process = subprocess.Popen(['gh', 'pr', 'create', '--title', f"AI generated doc titled {filename}", '--body',  f"This PR was generated by AI for an existing Azure Doc: {filename}. Please review and merge.", '--label', label, '--head', branch_name], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
